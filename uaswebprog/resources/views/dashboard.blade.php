        ...
        <div class="lg:flex lg:items-start lg:gap-8">
            <div class="lg:w-2/7 mb-6 lg:mb-0">
                <img src="{{ asset('images/aloha.jpeg') }}" alt="Aloha Guest House"
                    class="w-full h-auto rounded shadow-md ml-10" style="width: 25rem; height: 25rem; object-fit: cover;">
            </div>
            <div class="lg:w-2/3 mt-20">
                <h2 class="text-3xl font-bold mb-4">ALOHA GUEST HOUSE</h2>
                <p class="text-gray-700 text-justify">
                    Aloha Guest House berlokasi strategis di Cluster Allogio, Gading Serpong, dengan akses mudah ke
                    berbagai fasilitas utama. Hanya 5 menit dari Universitas Multimedia Nusantara (UMN) dan Summarecon
                    Digital Center (SDC), serta 20 menit ke Lippo Karawaci dan Alam Sutera, hunian ini sangat ideal bagi
                    mahasiswa dan profesional muda. BSD City dapat dicapai dalam 30-35 menit, dan berbagai tempat makan
                    serta minimarket tersedia di sekitar kost untuk memenuhi kebutuhan sehari-hari. Shuttle bus dari
                    Allogio ke SDC dan Summarecon Mall Serpong (SMS) memudahkan mobilitas, termasuk akses transportasi
                    ke Jakarta. Aloha Guest House menawarkan kenyamanan dan kemudahan di lokasi yang strategis.
                </p>
            </div>
        </div>
    </div>
